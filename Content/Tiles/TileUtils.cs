...
namespace ChallengeRooms.Content.Tiles
{
    public static class TileUtils
    {
        ...
        public static Point16 GetTileOrigin(int i, int j, bool noPadding = false)
        {
            ...
            Point16 frame = new Point16(tile.TileFrameX / (noPadding ? 16 : 18), tile.TileFrameY / (noPadding ? 16 : 18));
        ...
        {
            Point16 origin = GetTileOrigin(i, j, true);
